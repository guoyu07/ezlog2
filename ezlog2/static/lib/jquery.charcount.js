 ...
 * Date: 13-1-20
 * Time: 上午10:41
 http://www.cnblogs.com/rush/archive/2013/01/30/2883694.html#lb0
 */
    ...
    $.fn.charCount = function (options) {
        ...
        function calculate(obj) {
            ...
            if (available < 0) {
                ...
                $('#tweet_send_button').addClass('disabled');
                $(obj).next().html("已经超出 " + (-available));
            }
            else {
                $(obj).next().removeClass(options.cssExceeded);
                $('#tweet_send_button').removeClass('disabled');
                $(obj).next().html(options.counterText+" " + available);
            }
